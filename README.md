...
A full-stack healthcare platform with AI chat, voice interaction, bilingual (English + Telugu) responses, nearby doctor/hospital search, and role-based dashboards for Patients, Doctors, and Admins.
...
### Doctor
- Patient list with health profiles
...
│   └── src/
│       ├── components/patient/       # PatientChat (AI + voice + location)
