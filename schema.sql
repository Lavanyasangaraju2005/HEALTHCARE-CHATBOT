...
-- ============================================
-- Table: doctors (with location data)
-- ============================================
...
-- ============================================
-- Insert Sample Doctors with Location Data (Hyderabad - User's Detection Area)
-- ============================================
INSERT INTO doctors (name, specialization, latitude, longitude, available) VALUES
-- Cardiologists
('Dr. Rajesh Kumar', 'Cardiologist', 13.9068, 78.7135, TRUE),
('Dr. Priya Sharma', 'Cardiologist', 13.9095, 78.7160, TRUE),

-- General Practitioners
('Dr. Amit Patel', 'General Practitioner', 13.9040, 78.7110, TRUE),
('Dr. Neha Singh', 'General Practitioner', 13.9130, 78.7180, TRUE),

-- Dermatologists
('Dr. Vivek Desai', 'Dermatologist', 13.9085, 78.7145, TRUE),
('Dr. Anjali Reddy', 'Dermatologist', 13.9050, 78.7125, FALSE),

-- Orthopedic Surgeons
('Dr. Rohan Gupta', 'Orthopedic Surgeon', 13.9105, 78.7155, TRUE),
('Dr. Meera Nair', 'Orthopedic Surgeon', 13.9070, 78.7100, TRUE),

-- Neurologists
('Dr. Suresh Iyer', 'Neurologist', 13.9055, 78.7140, TRUE),
('Dr. Ananya Verma', 'Neurologist', 13.9100, 78.7170, TRUE),

-- Pediatricians
('Dr. Karthik Rao', 'Pediatrician', 13.9075, 78.7115, TRUE),
('Dr. Deepika Mishra', 'Pediatrician', 13.9090, 78.7130, TRUE),

-- Psychiatrists
('Dr. Vikram Yadav', 'Psychiatrist', 13.9065, 78.7120, TRUE),
('Dr. Pooja Kapoor', 'Psychiatrist', 13.9110, 78.7165, FALSE),

-- Ophthalmologists
('Dr. Arun Bhat', 'Ophthalmologist', 13.9080, 78.7150, TRUE),
('Dr. Shreya Nambiar', 'Ophthalmologist', 13.9045, 78.7105, TRUE),

-- ENT Specialists
('Dr. Sameer Khan', 'ENT', 13.9070, 78.7135, TRUE),
('Dr. Ritika Bose', 'ENT', 13.9095, 78.7175, TRUE)
ON DUPLICATE KEY UPDATE name=name;
